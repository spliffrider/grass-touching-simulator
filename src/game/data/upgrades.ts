...
export const UPGRADES: UpgradeDefinition[] = [
  ...
  {
    id: "persistent_touch",
    name: "Persistent Touch",
    description: "Hold left mouse button to keep touching grass. Each level repeats a little faster.",
    baseCost: 130,
    costGrowth: 2.18,
    maxLevel: 4,
    prerequisiteIds: ["two_handed_technique"],
    iconAsset: "palm_press",
    tree: { x: 690, y: 130, icon: "hold", color: 0xc9f27b },
    apply: () => {},
    isUnlocked: (state) => state.lifetimeGrassTouches >= 120,
  },
  {
